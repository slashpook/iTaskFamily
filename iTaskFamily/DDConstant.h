...
#define COULEUR_BLEU [UIColor colorWithRed:56/255.0 green:143/255.0 blue:218/255.0 alpha:1.0]
#define COULEUR_VERT [UIColor colorWithRed:36/255.0 green:199/255.0 blue:90/255.0 alpha:1.0]
#define COULEUR_ORANGE [UIColor colorWithRed:240/255.0 green:139/255.0 blue:0/255.0 alpha:1.0]
#define COULEUR_VIOLET [UIColor colorWithRed:137/255.0 green:60/255.0 blue:169/255.0 alpha:1.0]
#define COULEUR_ROUGE [UIColor colorWithRed:225/255.0 green:51/255.0 blue:41/255.0 alpha:1.0]
...
#define POLICE_EVENT_NO_PLAYER [UIFont fontWithName:@"HelveticaNeue-Thin" size:27.0]
#define POLICE_EVENT_NO_EVENT [UIFont fontWithName:@"HelveticaNeue-Thin" size:27.0]
...
#define POLICE_PLAYER_TITLE_REWARD [UIFont fontWithName:@"HelveticaNeue-Light" size:18.0]
#define POLICE_PLAYER_CONTENT [UIFont fontWithName:@"HelveticaNeue" size:17.0]
#define POLICE_PLAYER_CONTENT_REWARD [UIFont fontWithName:@"HelveticaNeue" size:15.0]
#define POLICE_PLAYER_REWARD [UIFont fontWithName:@"HelveticaNeue-Light" size:22.0]
#define POLICE_CROPPER_TITLE [UIFont fontWithName:@"HelveticaNeue-Thin" size:45.0]
...
#define POLICE_METEO_SETTING_TITLE [UIFont fontWithName:@"HelveticaNeue-Light" size:20.0]
#define POLICE_METEO_SETTING_DESC [UIFont fontWithName:@"HelveticaNeue-Medium" size:20.0]
#define POLICE_METEO_SETTING_CONTENT [UIFont fontWithName:@"HelveticaNeue" size:17.0]
