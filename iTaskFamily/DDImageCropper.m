...
- (void)setup {
    ...
    cropView = [DDImageCropper initialCropViewForImageView:imageView];
...
- (void)loadImage:(UIImage *)newImage withMaxSize:(CGSize)maxSize
{
    ...
    imageView.frame = CGRectInset(self.bounds, IMAGE_CROPPER_OUTSIDE_STILL_TOUCHABLE, IMAGE_CROPPER_OUTSIDE_STILL_TOUCHABLE);
...
- (UIImage*) getCroppedImage {
    ...
    if (rect.size.height < 350 || rect.size.width < 350)
        return nil;
